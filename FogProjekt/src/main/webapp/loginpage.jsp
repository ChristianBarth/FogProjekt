                ...
                <div class="card card-inverse">
                    ...
                    <div class="card-img-overlay bg-overlay">
                        ...
                        <form name="loginuser"action="LoginServlet" method="POST">
                            ...
                            <h4 class="card-title text-shadow text-white text-uppercase mb-0">Indtast din email:</h4>
                        ...
                        <br>
                        <a href="registeruser.jsp">Har du ikke noget account? registrer dig her!</a>
                        <br><br>
