                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item px-lg-4">
                            <a class="nav-link text-uppercase text-expanded" href="loginpage.jsp">View orders</a>
                        </li>
                        <li class="nav-item px-lg-4">
                ...
                <div class="card card-inverse">
                    ...
                    <div class="card-img-overlay bg-overlay">
                        ...
                        <form name="showusercarport" action="DrawingServlet" method="POST">
                            ...
                            <h4 class="card-title text-shadow text-white text-uppercase mb-0">Indtast længde på carport:</h4>
                            <input type="text" name="length" value="" placeholder="Maks 1000"/> 
                            <br><br>
                            <h4 class="card-title text-shadow text-white text-uppercase mb-0">Indtast bredde på carport:</h4>
                            <input type="text" name="width" value="" placeholder="Maks 1000"/>
                            <br><br>
                            <h4 class="card-title text-shadow text-white text-uppercase mb-0">Indtast højde på carport:</h4>
                            <input type="text" name="height" value="" placeholder="Maks 1000"/>
                            <br><br>
                            <select name="option"> 
                                <option value="YesSkur">Med skur</option>
                                <option value="NoSkur">Uden Skur</option>
                            </select>
                            <input class="btn btn-secondary" type="submit" value="Vis carport">
                        </form>
                        <br><br>
