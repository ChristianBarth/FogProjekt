    ...
    <body>
        ...
        <div class="container" align="center">
            <div class="bg-faded2 p-4 my-4" opacity="0.5">
                <h1 class="text-shadow text-white"  text-align: center>Kvittering af carport</h1>
                <table>
                    <tr>
                ...
                <br>
                <h3 class="text-shadow text-white">Total pris af din carport: <% out.println(totalPrice);%> DKK </h3>
            </div>
        </div>
        <br>
