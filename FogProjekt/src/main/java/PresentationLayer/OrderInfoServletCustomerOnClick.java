 ...
 * @author PC
 */
@WebServlet(name = "OrderInfoServletCustomerOnClick", urlPatterns = {"/OrderInfoServletCustomerOnClick"})
public class OrderInfoServletCustomerOnClick extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            ArrayList<Product> orderdetails = LogicFacade.getOrderDetails();
                ...
                request.setAttribute("totalpricecustomer", totalPrice);
